...
public enum PromptBuilder {
    ...
    public static func systemPrompt(options: Options) -> String {
        ...
        if options.webSearchEnabled {
            lines.append("")
            lines.append("联网补充（你具备联网检索能力）：本地不支持新闻/公告/舆情等维度，但你可以主动检索该股票的最新新闻、公告与市场舆情来补充判断；检索到的内容属于“情绪面/舆情因子”，必须与本地资金面、技术面数据交叉验证后再下结论，不能单独作为买卖依据。引用时必须注明信息来源机构与发布时间，明确区分“检索所得”与“本地数据”，且不得让检索内容覆盖或凌驾于本地已给出的行情/资金/技术数据之上——本地数据与检索结论冲突时，以本地数据为准，检索内容仅作补充或风险提示。")
        } else {
            lines.append("")
